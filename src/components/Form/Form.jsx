...
const Form = ({ value, itemAdd, onChange }) => {
    return (
        <form onSubmit={handleSubmit} className='flex flex-wrap align-middle px-4 pt-4 md:px-8 md:pt-8'>
            <Input value={value} onChange={(item) => onChange(item)} className={'border-2 border-teal-500 shadow-xl bg-transparent focus:outline-none px-3 py-2 mb-3 md:mb-0'} placeholder={'Album name'} type={'text'} />
